            ...
            <Card style={{ minWidth: 340, maxWidth: 340 }}>
              <CardHeader
                title={
                  ...
                  >
                    <CalendarTodayIcon fontSize="small" /> 配信スケジュール.ics
                  </Typography>
                }
                subheader={
